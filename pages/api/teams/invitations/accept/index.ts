...
export default async function handler(req: NextApiRequest, res: NextApiResponse<any>) {
    ...
    const teamID = (await postgresClient.query(`SELECT "invitationTeamID" from "team-invitations" WHERE "invitationID" = $1`, [invitationData.invitationID])).rows[0].invitationTeamID;
